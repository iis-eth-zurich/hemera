...
vlog -incr -sv \
    ...
    "$ROOT/deps/axi/src/axi_demux_id_counters.sv" \
    "$ROOT/deps/axi/src/axi_id_remap_table.sv" \
    ...
    "$ROOT/deps/axi/src/axi_cut_intf.sv" \
    "$ROOT/deps/axi/src/axi_delayer.sv" \
    "$ROOT/deps/axi/src/axi_demux_intf.sv" \
    ...
    "$ROOT/deps/axi/src/axi_lite_cut_intf.sv" \
...
vlog -incr -sv \
    ...
    "+incdir+$ROOT/deps/axi/include/axi" \
    "+incdir+$ROOT/src/apb/include" \
    "$ROOT/deps/axi2mem/src/mem_to_banks.sv" \
    "$ROOT/deps/axi2mem/src/axi_to_mem.sv" \
    "$ROOT/deps/axi2mem/src/axi_to_mem_banked.sv" \
    "$ROOT/deps/axi2mem/src/axi_to_mem_intf.sv" \
...
vlog -incr -sv \
    ...
    "$ROOT/deps/hier-icache/RTL/L1_CACHE/register_file_2r_2w_icache.sv" \
